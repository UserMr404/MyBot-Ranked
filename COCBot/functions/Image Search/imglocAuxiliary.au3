...
Func GetButtonDiamond($sButtonName)
	...
	Switch $sButtonName
		...
		Case "AttackButton", "RescueATKButton" ;Main Window Screen (Legacy)
			$btnDiamond = GetDiamondFromRect2(0, 540 + $g_iBottomOffsetY, 160, 660 + $g_iBottomOffsetY)
		Case "NormalAttackButton" ;Normal Attack Button (New Dual System)
			$btnDiamond = GetDiamondFromRect2(0, 540 + $g_iBottomOffsetY, 120, 660 + $g_iBottomOffsetY)
		Case "RankedAttackButton" ;Ranked Attack Button (New Dual System)  
			$btnDiamond = GetDiamondFromRect2(130, 540 + $g_iBottomOffsetY, 250, 660 + $g_iBottomOffsetY)
		Case "TrashEvent"
